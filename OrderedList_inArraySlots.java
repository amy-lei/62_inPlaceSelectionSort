...
public class OrderedList_inArraySlots
    ...
    public OrderedList_inArraySlots
        ...
        // iterate through 
        for (int el = 0; el < unordered.size(); el++){
            // Replace el at current index with champ, save old value
            int champ = champIndex( unordered, el);
        ...
        // System.out.println( 
          ...
          // );           
            ...
            int replaced = unordered.set(el, unordered.get(champ));
            unordered.set( champ, replaced);
     ...
     */
     private int champIndex(ArrayList<Integer> unordered, int startingIndex) {
        int champ = Integer.MAX_VALUE;
        int index = 0;
        // iterate through 
        for (; startingIndex < unordered.size(); startingIndex++){
            // if <champ, current element becomes new champ
            if( unordered.get(startingIndex) < champ){
                champ = unordered.get(startingIndex);
                index = startingIndex;
            }
        }
